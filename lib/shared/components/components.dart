...
Widget buildPostItem(Map<String, UserModel>? usersForPosts, PostModel model,
    context, index, UserModel user, number) {
  UserModel? postUser;
  if (usersForPosts != null) {
    postUser = usersForPosts[model.uId];
  }
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                radius: 20.0,
                backgroundImage: model.uId == user.uId
                    ? NetworkImage('${user.image}')
                    : NetworkImage('${postUser?.image}'),
              ),
              const SizedBox(
                width: 15.0,
              ),
              ...
              children: [
                Expanded(
                  child: InkWell(
                    onTap: () {
                      navigateTo(
                          context: context, widget: LikesScreen(model: model));
                    },
                    child: Padding(
                      padding: const EdgeInsets.symmetric(
                        vertical: 5.0,
                        ...
                        children: [
                          ...
                          Text(
                            number == 1
                                ...
                                : '${HomeCubit.get(context).likesForUsersPosts[index]}',
                        ...
                        children: [
                          ...
                          Text(
                            number == 1
                                ...
                                : '${HomeCubit.get(context).commentForUsersPosts[index]}',
                            style: Theme.of(context).textTheme.caption,
                          ),
                        ],
                      ),
                  ...
                  onTap: () {
                    navigateTo(
                        ...
                        widget: CommentsScreen(
                            ...
                            numberOfComment: HomeCubit.get(context).comments,
                            index: index));
                  },
                  child: Row(
                    children: [
                ...
                onTap: () {
                  number == 1
                      ? HomeCubit.get(context).likePost(
                          ...
                          number)
                      : HomeCubit.get(context).likePost(
                          HomeCubit.get(context).postIdsForOwen[index],
                          index,
                          model,
                          user,
                          number);
